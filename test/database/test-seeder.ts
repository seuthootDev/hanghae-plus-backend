...
export class TestSeeder {
  ...
  async seedFullTestData(): Promise<void> {
    ...
    // 상품 데이터 (ID를 명시적으로 설정)
    const products = [
      { id: 1, name: '아메리카노', price: 3000, stock: 100, category: '음료' },
      { id: 2, name: '카페라떼', price: 4000, stock: 80, category: '음료' },
      { id: 3, name: '카푸치노', price: 4500, stock: 60, category: '음료' },
      { id: 4, name: '티라떼', price: 3500, stock: 40, category: '음료' },
      { id: 5, name: '에스프레소', price: 2000, stock: 120, category: '음료' },
    ];
